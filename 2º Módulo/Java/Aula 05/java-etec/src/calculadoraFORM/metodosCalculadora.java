...
public class metodosCalculadora extends JFrame {

    // nas linhas abaixo eu declaro os objetos da classe JLabel
    private final JLabel lbl_texto1;

    private final JLabel lbl_texto2;
    ...
    public metodosCalculadora() {
        ...
        setLocation(800, 300);          // defino a localição da janela
    ...
    public void inicia() {
        ...
        // nas linhas abaixo eu posiciono os objetos na janela através do setBounds
    ...
    // crio a classe que conterá o métodos de calculos que serão invocados
    ...
    private class Operacoes implements ActionListener {
        ...
        public void actionPerformed(ActionEvent elemento) {
            ...
            // verifica se o objeto sofreu ação é o botão de Somar e executa o evento
            if (elemento.getSource() == btn_somar) {
                ...
                if ((txt_valor1.getText().equals("")) || (txt_valor2.getText().equals(""))) {
                    ...
                    // as variáveis recebem os valores digitados na caixa de textos
                    ...
                    // seta o campo texto de resultado com o retorno do valor da chamada do método da classe Calculos
            ...
            // verifica se o objeto sofreu ação é o botão de Subtrair e executa o evento
            ...
            // verifica se o objeto sofreu ação é o botão de Multiplicar e executa o evento
            ...
            // verifica se o objeto sofreu ação é o botão de Dividir e executa o evento
